...
# ===========================================================================
# 10. ONE-LEVEL NESTED SECRET LOCATOR — V2.6
# ===========================================================================
...
''',
    ...
    pub visible_doors: usize,
''',
    "nested-secret metadata field",
)

old_nested_locator = r'''fn scout_secret_rooms(rooms: &[Room], level: &Level) -> Vec<ScoutSecretRoomMetadata> {
    let mut output = Vec::new();
...
new_nested_locator = r'''/// SHPD-NESTED-SECRET-LOCATOR-V2.6
...
s = replace_once(
    ...
    old_nested_locator,
    new_nested_locator,
    "nested-aware scout_secret_rooms",
)
write(rel, s)
...
s = replace_once(
    ...
    old_summary,
    new_summary,
    "nested-secret Scout display",
)
write(rel, s)

print("Seed Seeker Plus V2.6 COMPLETE applied successfully.")
